	...
	return (
		<>
			<div className='flex justify-center items-center w-full h-[100vh] bg-cover' style={{ backgroundImage: `url(${bg})` }}>
				<form onSubmit={handleSignIn} className=' flex flex-col items-center justify-center w-[90%] h-[500px] max-w-[400px] bg-[#00000062] backdrop-blur shadow-lg shadow-black opacity-90 px-5 gap-[20px]'>
					<h1 className='text-white text-[25px] mb-[30px] font-semibold text-center'>SignIn To <span className='text-blue-400'>Virtual Assistant</span></h1>
					...
					<button className='min-w-[150px] h-[50px] mt-[30px] text-black font-semibold bg-white rounded-full text-[19px] '  >Sign In</button>

					<p className='text-white text-[18px] cursor-pointer text-center' onClick={() => navigate("/signup")}>want to create a new account? <span className='text-blue-400 text-[18px] '>Sign Up</span></p>
				</form>
			</div>
		</>
	)
